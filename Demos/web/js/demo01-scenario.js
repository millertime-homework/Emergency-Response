...
if (newRoom = firstFloor.addRoom('5thhall', 'SW 5th & Hall', 0, 0, 0)) {
...
if (newRoom = firstFloor.addRoom('north5th', 'Upper SW 5th & Hall', 0, 1, 0)) {
...
if (newRoom = firstFloor.addRoom('westhall', 'West on Hall', 1, 0, 0)) {
...
if (newRoom = firstFloor.addRoom('westhall2', 'West on Hall 2', 2, 0, 0)) {
...
if (newRoom = firstFloor.addRoom('SW 4th & Hall', 'SW 4th & Hall', 3, 0, 0)) {
